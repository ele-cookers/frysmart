import {
  ...
  STATE_BADGE_COLORS, VOLUME_BRACKET_COLORS,
...
export const OilBadge = ({ oil, competitors: comps, compact, theme }) => {
...
export const StateBadge = ({ state, theme }) => {
...
export const CompetitorPill = ({ comp }) => {
  if (!comp) return null;
