...
export const mapVenue = (r) => ({
  ...
  fryerVolumes: r.fryer_volumes ?? {},
  volumeBracket: r.volume_bracket ?? '',
  defaultOil: r.default_oil_id ?? '',
  groupId: r.group_id ?? '',
  bdmId: r.bdm_id ?? '',
...
export const unMapVenue = (v) => ({
  ...
  fryer_volumes: v.fryerVolumes && Object.keys(v.fryerVolumes).length > 0 ? v.fryerVolumes : null,
  volume_bracket: v.volumeBracket || null,
  default_oil_id: v.defaultOil || null,
...
export const mapTrial = (r) => ({
  ...
  trialType: r.customer_type ?? null,
...
export const unMapTrial = (t) => ({
  ...
  customer_type: t.trialType || null,
