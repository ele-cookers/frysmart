...
export const TRIAL_STATUS_COLORS = {
  'pipeline':     { bg: '#f1f5f9', text: '#64748b', border: '#cbd5e1', label: 'Pipeline',     accent: '#94a3b8' },
  'active': { bg: '#dbeafe', text: '#1e40af', border: '#93c5fd', label: 'Active',       accent: '#3b82f6' },
  'pending':   { bg: '#fef3c7', text: '#a16207', border: '#fde047', label: 'Pending',      accent: '#fbbf24' },
  'accepted':    { bg: '#ecfccb', text: '#3f6212', border: '#bef264', label: 'Accepted',  accent: '#84cc16' },
  'successful':         { bg: '#d1fae5', text: '#065f46', border: '#6ee7b7', label: 'Successful',   accent: '#10b981' },
  'unsuccessful':        { bg: '#fee2e2', text: '#991b1b', border: '#fca5a5', label: 'Unsuccessful', accent: '#ef4444' },
};
