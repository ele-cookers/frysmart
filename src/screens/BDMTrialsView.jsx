  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .bdm-table-archive thead th { padding: 3px 4px !important; font-size: 8px !important; }
        .bdm-table-archive tbody td { padding: 3px 4px !important; font-size: 9px !important; }
